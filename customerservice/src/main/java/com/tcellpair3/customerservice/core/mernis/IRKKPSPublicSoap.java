...
public class IRKKPSPublicSoap
{
    ...
    public IRKKPSPublicSoap(){}

    public IRKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IRKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IRKExtendedSoapSerializationEnvelope envelope= new IRKExtendedSoapSerializationEnvelope(IRKExtendedSoapSerializationEnvelope.VER11);
