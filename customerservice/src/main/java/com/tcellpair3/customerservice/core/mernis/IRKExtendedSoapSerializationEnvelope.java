...
public class IRKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IRKDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new IRKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IRKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IRKDateTimeConverter dateTimeConverter = new IRKStandardDateTimeConverter();

    public IRKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IRKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IRKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IRKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IRKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IRKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
